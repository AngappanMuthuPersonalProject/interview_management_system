...
apply
    ...
    <div class="container box_center">
        ...
        <div class="form-group">
            ...
            <br>
            <label class="btn btn-primary" name="pid"><?php echo $cid; ?></label>
            </div>
...
//    echo $int_id;
    ...
    $query = "INSERT INTO applicants VALUES ($cid, '".$_POST['cname']."', '".$_POST['cdob']."', '".$_POST['cmob']."', '".$_POST['cemail']."','".$_POST['cadd']."','".$int_id."')";
